...
/**
 * Class containing method used for making API calls and related utility methods.
 *
 */
@ThreadSafe
public abstract class JCSHttpClient {
	 ...
	 * 
	 * @param endpoint Base URL of the APIs
	 */
	...
	/**
	 * 
	 * @param headers Headers in the form of map, that are to be present in the URL of the API calls
	 */
	...
	/**
	 * 
	 * @param credentials Object of type JCSCredentials, contains ACCESS_KEY and SECRET_KEY
	 * @param params Query Params in the API call
	 * @param headers Headers to be present in the API call
	 * @return CloseableHttpResponse object containing the details of response of the called API. 
	 ...
	 * @throws IOException
	 * 
	 * This method creates the request URL, populates required headers and then executes the request.
	 */
	protected CloseableHttpResponse makeRequest(JCSCredentials credentials, Map<String,String> params, Map<String, String> headers) throws InvalidKeyException, NoSuchAlgorithmException, IllegalStateException, ClientProtocolException, IOException{
		...
		Authorization authorization = new Authorization(endpoint.toString() , "GET", credentials.getJCSAccessKey(),credentials.getJCSSecretKey(), headers);
	 ...
	 * @param params Query parameters in the form of map that are to be present in the API being called.
