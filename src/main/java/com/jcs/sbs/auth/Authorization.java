...
/**
 * This class contains methods for adding required authorization parameters before sending the actual request.
 */
public class Authorization {
	 ...
	 * 
	 * @param url Request URL on which authorization parameters are to be added
	 * @param verb Request method of the API being called
	 * @param accessKey Unique Access Key of the JCS account  
	 * @param secretKey Secret Key of the JCS account
	 * @param headers Common headers that is to be added to any API request.
	 */
	...
	/**
	 * method to set some required common parameters like:
	 * JCSAccessKeyId, SignatureVersion, SignatureMethod etc.
	 * in 'params' map that will be used to create request url.
	 * 
	 * @param params Query parameters that is to be added to API request
	 */
	...
	/**
	 * Method to convert query params as java map to sorted query params as in format of request URLs
	 * @param params Query parameters as map
	 * @return Query parameters converted to UTF-8 string in format used in request URLs
	 ...
	 * @param params Request query parameters as a map
	 ...
	 * 
	 * @param params Initial map of request query parameters in which additional authorization parameters are to be added.
