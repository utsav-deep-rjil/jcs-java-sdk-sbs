...
public class JCSCredentialsProviderChain implements JCSCredentialsProvider{
    ...
    /**
     * 
     * @param credentialsProviders The list of available credentials providers viz.:
     * ConfigPropertiesCredentialsProvider, EnvironmentVarialbleCredentialsProvider and
    ...
    /**
     * 
     * @return A boolean value 'reuseLastProvider'. If it is true then the last credentials provider
     * will be used.
     */
    ...
    /**
     * 
     * @param reuseLastProvider A boolean value to set or unset value of reuseLastProvider
     */
