...
/**
 * Result class for the describe volumes operation.
 */
public class DescribeVolumesResult extends JCSResult implements Serializable, Cloneable {
    ...
    /**
     * Default constructor for DescribeVolumesResult object.
     */
    public DescribeVolumesResult() {
    }

    /**
     * Returns list of {@link com.jcs.sbs.model.Volume Volume} objects
     * corresponding to the describe volumes API response.
     * 
     * @return The list of {@link com.jcs.sbs.model.Volume Volume} objects,
    ...
    /**
     * Used internally to set the collection of {@link com.jcs.sbs.model.Volume
     * Volume} objects, passed as an argument in DescribeVolumesResult object.
     * 
     * @param volumes
     *            Collection of {@link com.jcs.sbs.model.Volume Volume} objects
     *            which is to be set in DescribeVolumesResult object.
     */
    ...
    /**
     * Sets the {@link com.jcs.sbs.model.Volume Volume} objects, passed as
     * varargs, in the DescribeVolumesResult object and returns the modified
     * DescribeVolumesResult object
     * 
     * @param volumes
     *            List of {@link com.jcs.sbs.model.Volume Volume} objects as
    ...
    /**
     * Sets the {@link com.jcs.sbs.model.Volume Volume} objects, passed as
     * collection of {@link com.jcs.sbs.model.Volume Volume} objects, in the
