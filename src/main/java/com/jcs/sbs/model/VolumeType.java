...
public enum VolumeType implements Serializable{
	...
	/**
	 * @param volumeTypeString Its the string from which enum value is to be created.
	 * @return an element of VolumeType enum value corresponding to the 'volumeTypeString' 
	 * @throws IllegalArgumentException If 'volumeTypeString' doesn't matches with any of the valid VolumeType enum value 
	 */
