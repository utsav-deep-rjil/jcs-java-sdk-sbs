...
public class JCSComputeClient extends JCSHttpClient implements JCSCompute{
	...
	/**
	Constructs a new client to invoke service methods on JCS Client. A credentials provider chain will be used that searches for credentials in this order: <br>
	...
	*/
	...
	/**
	 * Initializes the end-points of the APIs with the BASE_URL as in config.properties file
	 */
	private void init(){     
	...
	*/
	...
	@param deleteVolumeRequest Contains the parameters for DeleteVolume.
	...
	*/
	...
	@param describeVolumesRequest - Contains the parameters for DescribeVolumes.
	...
	*/
	...
	@param createSnapshotRequest - Contains the parameters for CreateSnapshot.
	...
	*/
	...
	@param deleteSnapshotRequest - Contains the parameters for DeleteSnapshot.
